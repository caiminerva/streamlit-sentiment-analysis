...
def app():
    ...
    st.title("Sentiment Analysis on GMOs in Food Consumption")
    st.subheader("By: John Cairo Minerva BSCS 3A - AI")

    st.subheader('Survey Topic')
    st.write('I conducted a survey among various individuals and ask if they agree or disagree that \
    whether they agree or disagree that GMOs are safe to consume and briefly explain their answer.  \
